...
>
        ...
        <center>
            <?php
                if (file_exists('temp/logo.png'))
                {    
                        echo '<img id="logo" src="temp/logo.png" style="object-fit: contain;width:25%;"><br> <br><br> ';
                } 
            if($message!=''){
       ...
       <div id="play_audio"></div>
        ...
        <audio id="insertIC" preload="none" >
     ...
     // Global events are bound against socket
        ...
        socket.on('impromptu_arrive', function (data) {
            ...
            if(data == true){
               ...
               var scan_video = "<video width='520' height='340' autoplay loop muted>"+
...
$("#show_video").html('') 
               ...
               console.log(data)
                   setTimeout(function(){  entry_posting_audio.pause() }, 300);
